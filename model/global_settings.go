...
type GlobalSettings struct {
	...
	ChatAIProviderID           *int64              `gorm:"column:chat_ai_provider_id;index;comment:AI聊天模型渠道ID" json:"chat_ai_provider_id"`
	ImageRecognitionProviderID *int64              `gorm:"column:image_recognition_provider_id;index;comment:图像识别模型渠道ID" json:"image_recognition_provider_id"`
	ImageGenerationProviderID  *int64              `gorm:"column:image_generation_provider_id;index;comment:AI绘图模型渠道ID" json:"image_generation_provider_id"`
	SummaryAIProviderID        *int64              `gorm:"column:summary_ai_provider_id;index;comment:群聊总结模型渠道ID" json:"summary_ai_provider_id"`
	TextEmbeddingProviderID    *int64              `gorm:"column:text_embedding_provider_id;index;comment:文本嵌入模型渠道ID" json:"text_embedding_provider_id"`
